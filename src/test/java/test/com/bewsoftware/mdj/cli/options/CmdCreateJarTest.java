/*
 *  File Name:    CmdCreateJarTest.java
...
import com.bewsoftware.mdj.cli.options.CmdCreateJar;
 ...
 */
public class CmdCreateJarTest
{

    public CmdCreateJarTest()
    {
    }
    ...
    /**
     * Test of execute method, of class CmdCreateJar.
     *
     * @param args
    ...
    {
        System.out.println("[CmdCreateJarTest.testExecute()]");
        CmdLine cmd = new MyCmdLine(args);
        Option instance = new CmdCreateJar();
