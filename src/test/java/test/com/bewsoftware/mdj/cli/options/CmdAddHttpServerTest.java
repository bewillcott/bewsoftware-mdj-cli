/*
 *  File Name:    CmdAddHttpServerTest.java
...
import com.bewsoftware.mdj.cli.options.CmdAddHttpServer;
 ...
 */
public class CmdAddHttpServerTest
{
// TODO: Redo this test when the {@linkplain CmdAddHttpServer} class
// has been finished.

    public CmdAddHttpServerTest()
    {
    }

    /**
     * Test of execute method, of class CmdAddHttpServer.
     */
    @Test
    public void testExecute()
    {
        System.out.println("[CmdAddHttpServerTest.testExecute()]");
        CmdLine cmd = new CmdLineStub();
        Option instance = new CmdAddHttpServer();
        Optional<Integer> expResult = Optional.empty();
        Optional<Integer> result = instance.execute(cmd);
        assertEquals(expResult, result);
    }

    private class CmdLineStub implements CmdLine
    {
        @Override
