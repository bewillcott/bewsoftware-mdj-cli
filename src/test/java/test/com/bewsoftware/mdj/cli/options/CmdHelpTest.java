...
import com.bewsoftware.mdj.cli.options.CmdHelp;
...
public class CmdHelpTest
{
    ...
    /**
     * Test of execute method, of class CmdHelp.
     *
     * @param args
    ...
    {
        System.out.println("[CmdHelpTest.testExecute()]");
        CmdLine cmd = new MyCmdLine(args);
        Option instance = new CmdHelp();
