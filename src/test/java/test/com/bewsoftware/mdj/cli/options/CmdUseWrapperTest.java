/*
 *  File Name:    CmdUseWrapperTest.java
...
import com.bewsoftware.mdj.cli.options.CmdUseWrapper;
 ...
 */
public class CmdUseWrapperTest
{
    public CmdUseWrapperTest()
    {
    }
    ...
    /**
     * Test of execute method, of class CmdUseWrapper.
     *
     * @param args
    ...
    {
        System.out.println("[CmdUseWrapperTest.testExecute()]");
        CmdLine cmd = new MyCmdLine(args);
        Option instance = new CmdUseWrapper();
